...
// Validate checks the field values on EnumSchema with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *EnumSchema) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on EnumSchema with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in EnumSchemaMultiError, or
// nil if none found.
func (m *EnumSchema) ValidateAll() error {
	return m.validate(true)
}

func (m *EnumSchema) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, EnumSchemaValidationError{
					field:  "ExternalDocs",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return EnumSchemaValidationError{
				field:  "ExternalDocs",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return EnumSchemaMultiError(errors)
	}

	return nil
}

// EnumSchemaMultiError is an error wrapping multiple validation errors
// returned by EnumSchema.ValidateAll() if the designated constraints aren't met.
type EnumSchemaMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m EnumSchemaMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m EnumSchemaMultiError) AllErrors() []error { return m }

// EnumSchemaValidationError is the validation error returned by
// EnumSchema.Validate if the designated constraints aren't met.
type EnumSchemaValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e EnumSchemaValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e EnumSchemaValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e EnumSchemaValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e EnumSchemaValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e EnumSchemaValidationError) ErrorName() string { return "EnumSchemaValidationError" }

// Error satisfies the builtin error interface
func (e EnumSchemaValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = EnumSchemaValidationError{}
